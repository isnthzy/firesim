...
if {[info exists ::env(FIRESIM_XILINX_BOARD_REPO_PATHS)] && $::env(FIRESIM_XILINX_BOARD_REPO_PATHS) ne ""} {
  set_param board.repoPaths [split $::env(FIRESIM_XILINX_BOARD_REPO_PATHS) ":"]
}
...
set wrapperFile ${root_dir}/vivado_proj/firesim.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v
...
if {[file exists [set constrFile [retrieveVersionedFile ${root_dir}/scripts/${iboard}.xdc $vivado_version]]]} {
    add_files -fileset impl_fileset -norecurse $constrFile
}
